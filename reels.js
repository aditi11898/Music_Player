const music = new Audio('audio/VM.mp3');
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((e) => {
    e.addEventListener('click', (el) => {
        index = el.target.id;
        // console.log(index);
        music.src = `audio/reel/${index}.mp3`;
        
        music.play();
        masterPlay.classList.remove('bi-play-fill');
        masterPlay.classList.add('bi-pause-fill');
        download_music.href =  `audio/reel/${index}.mp3`;
...
back.addEventListener('click', () => {
    ...
    music.src = `audio/reel/${index}.mp3`;
    poster_master_play.src = `img/reel/${index}.jpg`;
    music.play();
    masterPlay.classList.remove('bi-play-fill');
    masterPlay.classList.add('bi-pause-fill');
